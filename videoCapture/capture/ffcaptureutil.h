...
namespace FFCaptureURLS{
    static std::string CAMERA1_URL = "video=Integrated Camera";     //嵌入式摄像头
    static std::string CAMERA2_URL = "video=USB2.0 Camera"; //USB外接摄像头
    static std::string SCREEN_URL = "video=screen-capture-recorder";    //屏幕抓获，需要下载Screen Capturer Recorder
    static std::string AUDIO_URL = "audio=virtual-audio-capturer";  //屏幕声音，下载Screen Capturer Recorder会自带
    //static std::string MICROPHONE_URL = "audio=麦克风 (Realtek(R) Audio)";
    static std::string MICROPHONE_URL = "audio=耳机 (AirPods4)";  //外接麦克风的声音
};
